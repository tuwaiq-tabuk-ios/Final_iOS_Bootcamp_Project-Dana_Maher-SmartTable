...
class SignUpBusnessViewController: UIViewController {
  ...
  func setUpElements() {
    ...
    Utilities.styleTextField(iDRestaurant)
  ...
  func validateFields() -> String? {
    ...
    if iDRestaurant.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" ||
      resturantOfName.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" || emailTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" || paswwordTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == ""
    {
  ...
  @IBAction func signUp(_ sender: Any) {
    ...
    if error != nil {
      ...
      let restaurantID = iDRestaurant.text!.trimmingCharacters(in: .whitespacesAndNewlines)
      ...
      Auth.auth().createUser(withEmail: email, password: password) { (result, err) in
        ...
        if err != nil {
          ...
          db.collection("user").addDocument(data: ["resturantName": restaurntname,
                                                   "iD": restaurantID,
