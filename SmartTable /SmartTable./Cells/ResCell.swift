  ...
  //MARK: - Methode
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            locationLabel.widthAnchor
              .constraint(equalToConstant: 110),
            locationLabel.heightAnchor
              .constraint(equalToConstant: 35),
            
            dateLbl.topAnchor
              .constraint(equalTo: contentView.topAnchor, constant: 20),
            dateLbl.leadingAnchor
              .constraint(equalTo: contentView.leadingAnchor, constant: 10),
            dateLbl.trailingAnchor
              .constraint(equalTo: contentView.trailingAnchor, constant: -16),
            
            nameLbl.topAnchor
              .constraint(equalTo: dateLbl.bottomAnchor, constant: 5),
            nameLbl.leadingAnchor
              .constraint(equalTo: contentView.leadingAnchor, constant: 10),
            nameLbl.trailingAnchor
              .constraint(equalTo: contentView.trailingAnchor, constant: -16),
            
            
            emailLbl.topAnchor
              .constraint(equalTo: nameLbl.bottomAnchor, constant: 10),
            emailLbl.leadingAnchor
              .constraint(equalTo: contentView.leadingAnchor, constant: 10),
            emailLbl.trailingAnchor
              .constraint(equalTo: contentView.trailingAnchor, constant: -16),
            
            nosLbl.topAnchor
              .constraint(equalTo: emailLbl.bottomAnchor, constant: 10),
            nosLbl.leadingAnchor
              .constraint(equalTo: contentView.leadingAnchor, constant: 10),
            nosLbl.trailingAnchor
              .constraint(equalTo: contentView.trailingAnchor, constant: -16),
            
            seatLbl.topAnchor
              .constraint(equalTo: nosLbl.bottomAnchor, constant: 10),
            seatLbl.leadingAnchor
              .constraint(equalTo: contentView.leadingAnchor, constant: 10),
            seatLbl.trailingAnchor
              .constraint(equalTo: contentView.trailingAnchor, constant: -16),
            
            sectionLbl.topAnchor
              .constraint(equalTo: seatLbl.bottomAnchor, constant: 10),
            sectionLbl.leadingAnchor
              .constraint(equalTo: contentView.leadingAnchor, constant: 10),
            sectionLbl.trailingAnchor
              .constraint(equalTo: contentView.trailingAnchor, constant: -16)
        ])
    }
}
