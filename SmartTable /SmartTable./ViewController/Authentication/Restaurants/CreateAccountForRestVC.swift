...
class CreateAccountForRestVC: UIViewController {
  ...
  let nameTF: UITextField = {
    ...
    textField.setupTextField(with:  NSAttributedString(string: "Your restaurant name",
  ...
  private func setupViews() {
    ...
    NSLayoutConstraint.activate([
      ...
      passwordTF.bottomAnchor.constraint(equalTo: confirmPasswordTF.topAnchor, constant: -20),
