                ...
                self.db.collection("RestaurantProfile").document(user.uid).collection("Reservations")
                    .addSnapshotListener { (querySnapshot,
                        ...
                        if let e = error {
                            ...
                            for document in querySnapshot!.documents{
                                let data = document.data()
                                self.reservations.append(Reservations(date: data["date"] as? String ?? "NA" ,
                                                                      email: data["email"] as? String ?? "NA",
                                                                      name: data["name"] as? String ?? "NA",
                                                                      numberOfSeats: data["number of seats"] as? String ?? "NA",
                                                                      seat: data["seat"] as? String ?? "NA",
                                                                      section: data["section"] as? String ?? "NA",
                                                                      location: data["restaurantDescription"] as? String ?? "NA"))
                        ...
                        if let e = error {
                            ...
                            for document in querySnapshot!.documents{
                                ...
                                self.reservations.append(Reservations(date: data["date"] as? String ?? "NA" ,
                                                                      ...
                                                                      seat: data["seat"] as? String ?? "NA",
                                                                      section: data["section"] as? String ?? "NA",
                                                                      location: data["restLocation"] as? String ?? "NA"))
...
extension RestaurantReservationVC: UITableViewDelegate,
    ...
    func tableView(_ tableView: UITableView,
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: ResCell.id,
                                                 for: indexPath) as! ResCell
...
extension RestaurantReservationVC: UISearchResultsUpdating,
                                   UISearchBarDelegate {
